...
function fixupTabelaMatriculas() {
  ...
  $j('<p>').addClass('title-table-matricula').html(stringUtils.toUtf8('<strong>Participações Processo Seletivo:</strong>')).appendTo($parentTd);
...
$j('td .formdktd').append('<div id="tabControl"><ul><li><div id="tab1" class="alunoTab2"> <span class="tabText">Dados pessoais</span></div></li><li><div id="tab2" class="alunoTab2"> <span class="tabText">Processo Seletivo</span></div></li></ul></div>');
$j('td .formdktd b').remove();
$j('#tab1').addClass('alunoTab-active2').removeClass('alunoTab2');
var linha_inicial_fselecao = 0;

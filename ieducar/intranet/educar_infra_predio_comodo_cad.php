...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		$this->campoMemo( "desc_comodo", "Descri��o C&ocirc;modo", $this->desc_comodo, 60, 5, false );
	}
...
function getInfraPredio(xml_infra_predio)
{
	...
	*/
	...
	if(DOM_array.length)
	{
		...
		campoPredio.options[0].text = 'A escola n�o possui nenhum pr�dio';
...
function getInfraPredioFuncao(xml_infra_comodo_funcao)
{
	...
	*/
	...
	{
		campoFuncao.length = 1;
		campoFuncao.options[0].text = 'Selecione uma fun��o c�modo';
		...
		campoFuncao.options[0].text = 'A escola n�o possui nenhuma fun��o c�modo';
}
...
document.getElementById('ref_cod_escola').onchange = function()
{
	...
	*/
	...
	campoFuncao.options[0].text = 'Carregando fun��o c�modo';

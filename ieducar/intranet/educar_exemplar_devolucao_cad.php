...
//		echo $this->cod_emprestimo." / ".$this->pessoa_logada." / ".date('Y-m-d')." / ".$this->valor_multa;die;
		...
		{
			echo "<script> alert('ERRO - N�o foi poss�vel encontrar a situa��o DISPON�VEL da biblioteca utilizada!'); </script>";
			return false;

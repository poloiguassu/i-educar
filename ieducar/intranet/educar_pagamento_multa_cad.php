...
class indice extends clsCadastro
{
	...
	function Gerar()
	{
		...
		$this->campoMonetario( "valor_divida", "Total da D�vida", $this->valor_divida, 11, 11, false, "", "", "onChange", true );

		$this->campoMonetario( "valor_divida_bib", "Total da D�vida (Biblioteca)", $this->valor_divida_bib, 11, 11, false, "", "", "onChange", true );

...
//			$this->campoLista( "ref_ref_cod_serie", "S�rie", $opcoes_serie, $this->ref_cod_serie, "", false, "", $script, true);
		}
		else
		{
...
function getMaterialTipo(xml_material_tipo)
{
	...
	*/
	...
	if(DOM_array.length)
	{
		...
		campoTipoMaterial.options[0].text = 'A institui��o n�o possui nenhum tipo de material';
}

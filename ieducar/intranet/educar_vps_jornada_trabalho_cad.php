...
class indice extends clsCadastro
{
	...
	function Novo()
	{
		...
		$obj = new clsPmieducarVPSJornadaTrabalho( $this->cod_vps_jornada_trabalho, $this->pessoa_logada, $this->pessoa_logada, $this->nm_jornada_trabalho, $this->data_cadastro, $this->data_exclusao, $this->ativo, $this->ref_cod_instituicao );
	...
	function Excluir()
	{
		...
		$obj = new clsPmieducarVPSJornadaTrabalho($this->cod_vps_jornada_trabalho, $this->pessoa_logada, $this->pessoa_logada, $this->nm_jornada_trabalho, $this->data_cadastro, $this->data_exclusao, 0, $this->ref_cod_instituicao);
		$excluiu = $obj->excluir();
		if( $excluiu )
		{

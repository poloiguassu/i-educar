...
class clsCadastro extends clsCampos
{
	...
	function Processar()
	{
		...
		if (empty($this->tipoacao))
		{
			...
			if ($this->tipoacao == 'Novo')
			{
				...
				{
					$this->mensagem = "N�o foi poss�vel inserir a informa��o. [CAD01]";
				}
			}
			elseif ($this->tipoacao == 'Editar')
			{
				...
				if (!$sucesso && empty($this->erros) && empty($this->mensagem))
				{
					$this->mensagem = "N�o foi poss�vel editar a informa��o. [CAD02]";
				}
			}
			elseif ($this->tipoacao == 'Excluir')
			{
				...
				if (!$sucesso && empty($this->erros) && empty($this->mensagem))
				{
					$this->mensagem = "N�o foi poss�vel excluir a informa��o. [CAD03]";
				}
			}
			elseif ($this->tipoacao == 'ExcluirImg')
			{
				...
				if (!$sucesso && empty( $this->erros ) && empty( $this->mensagem ))
				{
					$this->mensagem = "N�o foi poss�vel excluir a informa��o. [CAD04]";
				}
			}
	...
	function RenderHTML()
	{
		...
		*/
		...
		{
			$retorno .=  "<tr><td class='linhaSim' colspan='2'><span class='form'>N�o existe informa��o dispon�vel</span></td></tr>";
		} else {

...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
/**
 * Ao incluir este arquivo, adicionar a vari�vel $obrigatorio = true ou $obrigatorio = false para
 * definir se os campos s�o obrigat�rios ou n�o. Adicionar tamb�m a vari�vel editar para informar
 * se est� sendo editados os itens ou n�o.
 *
 * Ex.:
 * $obrigatorio = true;
 * $editar      = true;
...
if ( $privilegio == 4 ) {
	...
	$this->campoLista( "ref_ref_cod_serie", "S�rie", $opcoes, $this->ref_ref_cod_serie, "", false, "", "", false, $obrigatorio );
...
function CursoSerie()
{
	...
	try {
		...
		if ( tamanho == 0 ) {
			campoSerie.options[0].text = \"Projeto sem s�rie\";
		}
		else {

    ...
    */
    public function __construct(
        ...
        $this->_campos_lista = $this->_todos_campos = 'i.cod_inscrito,
            i.ref_cod_selecao_processo, i.ref_cod_aluno, i.estudando_escola,
            i.estudando_serie, i.egresso, i.estudando_turno, i.guarda_mirim,
            i.copia_rg, i.copia_cpf, i.copia_residencia, i.copia_historico,
            i.copia_renda, i.area_interesse, i.area_selecionado, i.encaminhamento,
            i.ref_usuario_exc, i.ref_usuario_cad, i.data_cadastro, i.data_exclusao,
            i.ativo';
    }
    ...
    public function listaAvaliacao(
        ...
        $this->_campos_lista = " cod_inscrito, nome,
            data_nasc, sexo, area_selecionado, copia_rg, copia_cpf, copia_residencia,
    ...
    public function excluir()
    {
        if (is_numeric($this->cod_inscrito)) {
            ...
            $objEtapas = new clsPmieducarInscritoEtapa();
            $objEtapas->ref_cod_inscrito = $this->cod_inscrito;
            if ($objEtapas->detalhe()) {
                $objEtapas->excluirTodas();
            }

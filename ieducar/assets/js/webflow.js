...
/***/ function(module, exports, __webpack_require__) {
	...
	Webflow.define('forms', module.exports = function($, _) {
	  ...
	  function getStatus(field, type, name, value) {
	    ...
	    if (type === 'password') {
			if (!value) {
				status = 'Por favor preencha o campo obrigat�rio: ' + name;
			}
	    } else if (field.attr('required')) {
	      if (!value) {
	        status = 'Por favor preencha o campo obrigat�rio: ' + name;
	      } else if (emailField.test(name) || emailField.test(field.attr('type'))) {
	        if (!emailValue.test(value)) status = 'Por favor entre um email v�lido: ' + name;
	      }
	    }
...
Webflow.require('ix').init([
  {"slug":"profile-menu","name":"profile-menu","value":{"style":{},"triggers":[{"type":"hover","selector":".submenu-profile","stepsA":[{"wait":200},{"display":"block","height":"auto","transition":"height 500ms ease 0ms"}],"stepsB":[{"height":"0px","transition":"height 500ms ease 0ms"},{"display":"none","wait":500}]}]}}
]);

...
/**
 * Portabilis_View_Helper_Input_MultipleSearchIdiomas class.
 *
 * @author    Lucas Schmoeller da Silva <lucas@portabilis.com.br>
 * @category  i-Educar
 * @license   @@license@@
...
class Portabilis_View_Helper_Input_Resource_MultipleSearchIdiomas extends Portabilis_View_Helper_Input_MultipleSearch {
  ...
  protected function getOptions($resources) {
    if (empty($resources)) {
      ...
      $resources = Portabilis_Array_Utils::setAsIdValue($resources, 'cod_vps_idioma', 'nm_idioma');
    }
    return $this->insertOption(null, '', $resources);
  }

  public function multipleSearchIdiomas($attrName, $options = array()) {
    $defaultOptions = array('objectName'    => 'idiomas',
